...
/// </summary>
public interface ICell : IGameComponent
{
    /// <summary>
    ...
    /// <summary>
    /// <see cref="ReadOnlyCollection{T}"/>  of <see cref="IGameComponent"/> objects that are contained inside this <see cref="ICell"/>.
    /// </summary>
    public ReadOnlyCollection<IGameComponent> Children { get; }

    /// <summary>
    /// Add a child <see cref="IGameComponent"/> object to the <see cref="ICell"/>
    /// </summary>
    ...
    /// <summary>
    /// Remove a child <see cref="IGameComponent"/> object from the <see cref="ICell"/>
    /// </summary>
    /// <param name="child"></param>
