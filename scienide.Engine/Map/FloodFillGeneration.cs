...
public class FloodFillGeneration
{
    ...
    public static List<RegionCellData> FloodFillMap(GameMap map)
    {
        ...
        do
        {
            ...
            var neighbourTraversableCells = current.FilterValidNeighbours(neighbourCell => !neighbourCell.IsValidCellForEntry(GObjType.NPC) || neighbourCell.Properties[Props.IsFloodFilled]);
            ...
            var regionBorderCells = current.FilterValidNeighbours(neighbourCell => neighbourCell.IsValidCellForEntry(GObjType.NPC));
